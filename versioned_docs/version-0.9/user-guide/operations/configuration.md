...
- [standalone](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/standalone.example.toml)
- [frontend](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/frontend.example.toml)
- [datanode](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/datanode.example.toml)
- [flownode](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/flownode.example.toml)
- [metasrv](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/metasrv.example.toml)
...
For all options, refer to the [Configuration Reference](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/config.md) on Github.
