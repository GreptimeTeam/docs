...
|            | max_connection_age   | String  | Maximum lifetime of a gRPC connection before the server gracefully closes it. If not set, connections are not closed based on age. Example: "1h" for 1 hour, "30m" for 30 minutes                                                                                                                                                                                                           |
