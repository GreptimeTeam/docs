...
[`flownode.example.toml`](https://github.com/GreptimeTeam/greptimedb/blob/main/config/flownode.example.toml) 位于 GreptimeDB 仓库中。`-c` 用于指定配置文件，详见[配置文档](/user-guide/deployments-administration/configuration.md)。
