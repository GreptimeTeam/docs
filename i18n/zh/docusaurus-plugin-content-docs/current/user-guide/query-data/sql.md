...
在这篇文档中，我们将使用 `monitor` 表中的数据作为示例来演示如何查询数据。关于如何创建 `monitor` 表格并向其中插入数据，请参考[表管理](/user-guide/administration/data-management/basic-table-operations.md#创建表)和[写入数据](/user-guide/ingest-data/for-iot/sql.md)。
...
假设我们有以下数据在 [`monitor` 表](/user-guide/administration/data-management/basic-table-operations.md#创建表) 中：
