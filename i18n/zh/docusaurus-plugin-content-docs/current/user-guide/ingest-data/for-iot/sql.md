...
我们将使用 `monitor` 表作为示例来展示如何写入数据。有关如何创建 `monitor` 表的 SQL 示例，请参见[表管理](/user-guide/operations/data-management/basic-table-operations.md#创建表)。
...
有关 `CREATE TABLE` 语句的更多信息，请参阅[表管理](/user-guide/operations/data-management/basic-table-operations.md#create-a-table)。
