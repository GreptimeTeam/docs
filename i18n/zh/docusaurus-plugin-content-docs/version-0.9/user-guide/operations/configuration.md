...
- [独立模式](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/standalone.example.toml)
- [前端](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/frontend.example.toml)
- [数据节点](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/datanode.example.toml)
- [流节点](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/flownode.example.toml)
- [元服务](https://github.com/GreptimeTeam/greptimedb/blob/v0.9.2/config/metasrv.example.toml)
