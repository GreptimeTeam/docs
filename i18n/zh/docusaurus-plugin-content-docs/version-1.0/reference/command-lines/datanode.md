...
[`datanode.example.toml`](https://github.com/GreptimeTeam/greptimedb/blob/v1.0.2/config/datanode.example.toml) 位于 GreptimeDB 仓库中。`-c` 选项用于选择配置文件，详见[配置](/user-guide/deployments-administration/configuration.md)。
