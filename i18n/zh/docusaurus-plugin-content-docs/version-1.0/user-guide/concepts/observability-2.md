...
- **OB Cloud**：从 Loki 迁移到 GreptimeDB 一年后，已沉淀 80+ 集群、300TB 多云日志和 SQL 审计数据，整体存储成本下降 60%+。[详情 →](https://greptime.cn/blogs/2025-07-22-user-case-obcloud-log-storage-greptimedb)
