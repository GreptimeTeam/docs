...
const isBlogs = computed(() => isBlog(relativePath))
...
<template>
  <div class="VPDoc" :class="{ 'has-sidebar': hasSidebar, 'has-aside': hasAside, blog: isBlogs }">
    <slot name="doc-page-before" />
    <div class="container">
...
@media (min-width: 960px) {
  .blog:not(.has-sidebar) .container {
    justify-content: space-between;
    max-width: 1260px;
  }
  .blog:not(.has-sidebar) .content {
    max-width: 920px;
  }
}
...
.blog.has-aside .content-container {
  max-width: 920px;
}
</style>
