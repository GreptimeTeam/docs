---
keywords: [GreptimeDB functions, string functions, math functions, date and time functions, admin functions]
description: GreptimeDB-specific SQL functions and extensions beyond DataFusion.
---
