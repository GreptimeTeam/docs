...
For information on the host, database, username, and password required for the InfluxDB API, please refer to the InfluxDB documentation in [GreptimeDB](/v0.4/user-guide/clients/influxdb-line.md) or [GreptimeCloud](/v0.4/greptimecloud/integrations/influxdb.md).
