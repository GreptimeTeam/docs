...
For the syntax of creating a partitioned table, please refer to the [Table Sharding](/user-guide/administration/data-management/table-sharding.md) section in the User Guide.
