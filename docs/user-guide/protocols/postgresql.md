...
- For how to setup authentication for GreptimeDB, please refer to [Authentication](/operations/authentication.md).
- If you want to use other ports for PostgreSQL, please refer to [Protocol options](/operations/configuration.md#protocol-options) in the configuration document.
