...
- **Key Parameters**:
  - `useRpcSharedPool`: Whether to use global RPC shared thread pool, default false. By default, only gRPC internal IO threads are used to handle all tasks. It's recommended to start with the default value for your application
