...
the database and emits alert when matches. For more details, please refer to [Rule Management](https://docs.greptime.com/user-guide/greptimecloud/integrations/prometheus/rule-management).
