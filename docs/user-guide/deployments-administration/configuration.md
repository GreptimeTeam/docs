...
| `default_region_write_buffer_size`       | String  | `0`           | Default write buffer size for each region. Regions flush when they reach this size and reject writes at twice this size. Setting it to `0` disables the default per-region limit unless a table specifies `write_buffer_size`.                                                                                                                                                                                                                                                                     |
