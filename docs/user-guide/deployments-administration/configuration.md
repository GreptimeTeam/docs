...
| `manifest_cache_size`                    | String  | `128MB`       | Cache size for region manifest. Setting it to 0 to disable the cache.<br/>If not set, it's default to 1/32 of OS memory with a max limitation of 128MB.                                                                                                                                                                                                                                                                                                                                            |
