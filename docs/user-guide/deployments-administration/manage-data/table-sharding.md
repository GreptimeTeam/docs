...
You must enable shared object storage and [GC](/user-guide/deployments-administration/manage-data/gc.md), and ensure all datanodes can access the same object store before running repartitioning operations.
:::
