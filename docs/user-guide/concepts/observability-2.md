...
| Structured logs and wide events | [Pipeline](/user-guide/logs/use-custom-pipelines.md), wide tables, and SQL | Parse and transform logs into structured events before storage, then keep selected events for detailed or retrospective analysis. |
