...
| --timeout | No | 0 | The timeout for a single call to the DB, default is 0 which means never timeout(Example: `30s` means 30 seconds, `10min 20s` means 10 minutes and 20 seconds) |
