...
Please refer to [table management](/user-guide/table-management.md#http-api), [write data](/user-guide/ingest-data/for-iot/sql.md#http-api) and [query data](/user-guide/query-data/sql.md#http-api) in user guide.
