...
- [Why GreptimeDB](./why-greptimedb.md)：介绍了 GreptimeDB 的特点和优势，包括其针对指标和事件数据而设计的灵活架构，允许在各种环境中部署，从嵌入式到云原生等。GreptimeDB 还具有成本效益、高性能和用户友好等特点。
...
- [关键特性](./features-that-you-concern.md): 介绍了 TSDB 用户较为关心的指标和事件数据库的特性。
