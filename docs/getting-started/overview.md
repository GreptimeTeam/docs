...
Using the `INSERT` statement is an easy way to add data to your table. Through the following statement, we have inserted several rows into the `system_metrics` table.
