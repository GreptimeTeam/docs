...
* `Authorization`: `Basic` 认证，是 `<username>:<password>` 的 Base64 编码字符串。更多信息请参考 [鉴权](/user-guide/clients/authentication) 和 [HTTP API](/user-guide/clients/http-api#authentication)。
