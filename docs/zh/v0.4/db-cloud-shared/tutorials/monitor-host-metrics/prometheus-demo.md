...
通过上面的配置文件，Prometheus 从 node exporter 中抓取指标并将其发送到 GreptimeDB。有关 `<host>`, `<dbname>`, `<username>` 和 `<password>` 的信息，请参考 [GreptimeDB](/zh/v0.4/user-guide/clients/prometheus.md) 或 [GreptimeCloud](/zh/v0.4/greptimecloud/integrations/prometheus/quick-setup.md) 中的 Prometheus 文档。
