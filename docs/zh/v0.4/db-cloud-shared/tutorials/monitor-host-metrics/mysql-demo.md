...
请参阅 [GreptimeDB](/zh/v0.4/user-guide/clients/mysql.md) 或 [GreptimeCloud](/zh/v0.4/greptimecloud/integrations/mysql.md) 中的 MySQL 文档以获取命令中的 `host`、`database`、`username` 和 `password` 信息，
