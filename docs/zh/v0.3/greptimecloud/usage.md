...
1. 获取表结构中每个列的数据类型的大小。你可以在 [数据类型](/v0.3/reference/data-types.md) 文档中找到有关每个数据类型大小的详细信息。
...
该请求的大小为 950 字节（38 _ 25）。此请求的 WCU 为 1。如果你在单个语句中插入 40 行数据，则大小为 1520 字节（38 _ 40），此请求的 WCU 为 2。
