...
:::tip NOTE
注意：GreptimeDB 提供了一种 schemaless 方法来写入数据，不需要使用额外的协议手动创建表。参见 [自动生成表结构](/v0.3/user-guide/write-data/overview.md#自动生成表结构)\*\*。
:::
...
关于 SQL HTTP 请求的更多信息，请参考 [API 文档](/v0.3/reference/sql/http-api.md)。
