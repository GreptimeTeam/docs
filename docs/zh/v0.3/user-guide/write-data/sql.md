...
通过上面的语句，我们成功的向 `monitor` 表中插入了三条数据。请参考 [`INSERT`](/v0.3/reference/sql/insert.md) 获得更多写入数据的相关信息。
...
请参考 [API document](/v0.3/reference/sql/http-api.md) 获取更多信息。
...
请参考 [SQL DELETE](/v0.3/reference/sql/delete.md) 获取更多信息。
...
请参考 [API 文档](/v0.3/reference/sql/http-api.md)获取更多信息。
