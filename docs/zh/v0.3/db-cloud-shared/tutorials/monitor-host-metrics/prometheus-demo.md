...
通过上面的配置文件，Prometheus 从 node exporter 中抓取指标并将其发送到 GreptimeDB。有关 `<host>`, `<dbname>`, `<username>` 和 `<password>` 的信息，请参考 [GreptimeDB](/v0.3/user-guide/clients/prometheus.md) 或 [GreptimeCloud](/v0.3/greptimecloud/integrations/prometheus/quick-setup.md) 中的 Prometheus 文档。
