...
We use the simplest configuration for you to get started. For a comprehensive list of configurations available in GreptimeDB, see the [configuration documentation](/en/v0.4/user-guide/operations/configuration.md).
...
GreptimeDB supports [multiple protocols](/en/v0.4/user-guide/clients/overview.md). We use MySQL client here for simplicity.
...
**Note: GreptimeDB offers a schemaless approach to writing data that eliminates the need to manually create tables using additional protocols. See [Automatic Schema Generation](/en/v0.4/user-guide/write-data/overview.md#automatic-schema-generation).**
...
- The table can be created automatically if you are using other protocols. See [Create Table](/en/v0.4/user-guide/table-management#create-table).
- For more information about creating table SQL, please refer to [CREATE](/en/v0.4/reference/sql/create.md).
- For data types, please check [data types](/en/v0.4/reference/data-types.md).
...
For more information about the `SELECT` statement, please refer to [SELECT](/en/v0.4/reference/sql/select.md).
...
- [Concepts](/en/v0.4/user-guide/concepts/overview.md)
- [Clients](/en/v0.4/user-guide/clients/overview.md)
- [Table management](/en/v0.4/user-guide/table-management.md)
- [Write data](/en/v0.4/user-guide/write-data/overview.md)
- [Query data](/en/v0.4/user-guide/query-data/overview.md)
- [Scripts-&-functions](/en/v0.4/user-guide/scripts-&-functions/overview.md)
- [Cluster](/en/v0.4/user-guide/cluster.md)
- [Operations](/en/v0.4/user-guide/operations/overview.md)
