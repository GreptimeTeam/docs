...
Please refer to [SELECT](/en/v0.4/reference/sql/select.md) for more information.
...
Please refer to [Functions](/en/v0.4/reference/sql/functions.md) for more information.
...
Please refer to [GROUP BY](/en/v0.4/reference/sql/group_by.md) for more information.
...
Please refer to [INTERVAL](/en/v0.4/reference/sql/functions.md#interval) for more information.
...
Please refer to [arrow_cast](/en/v0.4/reference/sql/functions.md#arrow-cast) for more information.
...
Please refer to [::timestamp](/en/v0.4/reference/sql/functions.md#timestamp) for more information.
...
The `DOY` in the SQL statement is the abbreviation of `day of the year`. Please refer to [date_part](/en/v0.4/reference/sql/functions.md#date-part) for more information.
