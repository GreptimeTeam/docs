...
- [**Meta**](/v0.4/developer-guide/metasrv/overview.md) is the central command of
...
- [**Frontend**](/v0.4/developer-guide/frontend/overview.md) is a stateless
  ...
  from _Meta_.
- [**Datanodes**](/v0.4/developer-guide/datanode/overview.md) hold regions of
...
You can refer to [architecture](/v0.4/developer-guide/overview.md) in developer guide to learn more details about how components work together.
