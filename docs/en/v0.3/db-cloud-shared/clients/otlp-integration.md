...
* Headers:
  ...
  * `Authorization`: `Basic` authentication, which is a Base64 encoded string of `<username>:<password>`. For more information, please refer to [Authentication](https://docs.greptime.com/v0.3/user-guide/clients/authentication) and [HTTP API](https://docs.greptime.com/v0.3/user-guide/clients/http-api#authentication)
