...
For information on the host, database, username, and password required for the MySQL API, please refer to the MySQL documentation in [GreptimeDB](/en/v0.3/user-guide/clients/mysql.md) or [GreptimeCloud](/en/v0.3/greptimecloud/integrations/mysql.md).
